...
class Cell {
    ...
    // snake's are green in the game
    public static Color COLOR = Color.green;
    
    // position of this cell in the world
    Posn cpos;
...
class Food {
    ...
    // position of this food in the world
    Posn fpos;
...
class Snake {
    ...
    // this snake's full body
    LinkedList<Cell> body;
    
    // this snake's body minus its head
    LinkedList<Cell> body2;
    
    // position of this snake's head in the world
    Posn spos;
...
class SnakeWorld extends World {
    ...
    // snake food in the world
    Food food;
    
    // snake in the world
    Snake snake;
    
    // is the snake facing north, east, south, or west
    String direction;
    
    // to aid snake in changing direction
    String direction2;
    ...
    // grow the snake if food is eaten and increase score and keep the snake moving
    // else, merely keep the snake moving
    void growSnake() {
        if (this.foodEaten()) {
